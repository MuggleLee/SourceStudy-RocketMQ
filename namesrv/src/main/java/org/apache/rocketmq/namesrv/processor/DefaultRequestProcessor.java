...
public class DefaultRequestProcessor implements NettyRequestProcessor {
    ...
    public RemotingCommand getRouteInfoByTopic(ChannelHandlerContext ctx, RemotingCommand request) throws RemotingCommandException {
        ...
        // 调用RouteInfoManager.pickupTopicRouteData()方法,从路由表topicQueueTable、brokerAddrTable、filterServerTable中分别
        // 填充TopicRouteData的List<QueueData>、List<BrokerData>、filterServer
        ...
        // 执行到这一步就代表找不到路由，返回 TOPIC_NOT_EXIST 响应码
